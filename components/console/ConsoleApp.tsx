...
export function ConsoleApp({ blogPosts, onCommandResult }: ConsoleAppProps) {
  ...
  const handleSubmit = useCallback(() => {
    ...
    const result = executeCommand(trimmed, { lang, blogPosts });
    ...
    setInput('');
  }, [blogPosts, input, lang, onCommandResult]);
