...
import { Contact, FileCog, FileText, Globe2, Layers3, LayoutDashboard, PanelsTopLeft, UserRound } from 'lucide-react';
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        >
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
            Create posts, publish drafts, import Blog Markdown, and export Blog backups from PostgreSQL.
          </p>
        </Link>
        <Link
          href="/admin/hero"
        ...
        >
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
            Configure site name, default metadata, author, locale, and social metadata.
          </p>
        </Link>
        <Link
          href="/admin/profile"
